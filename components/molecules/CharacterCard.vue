...
<template>
  <aside ref="id" class="card-character" tabindex="0" @click="emit('click')">
    ...
    <section class="content">
      ...
      <dl class="group">
        ...
        <dd class="-description mx-0 font-extrabold font-mono">{{ character.name }}</dd>
        ...
        <dd class="-description">{{ character.gender }}</dd>
      </dl>
    </section>
  </aside>
</template>
